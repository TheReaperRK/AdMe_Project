...
- *RF27*: Els usuaris poden guardar anuncis que els hi interessin, afeixintlos a la seva llista personal de favorits.
- *RF28*: Els usuaris podran llistar els anuncis guardats en la seva llista personal de favorits.
- *RF29*: Els usuaris podran borrar els anuncis de la seva llista personal de favorits.
